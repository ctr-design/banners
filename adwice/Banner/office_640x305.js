...
(lib.Символ23 = function() {
	...
	// Слой 1
	this.text = new cjs.Text("ВЫБЕРИ КОМАНДУ", "italic bold 28px 'Panton Black'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 30;
	this.text.lineWidth = 279;
	this.text.setTransform(139.5,0);

	this.addChild(this.text);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,283,49.3);
...
p.nominalBounds = new cjs.Rectangle(1,0,283,49.3);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(283,133.1,1,1,0,0,0,71,118.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:213},9,cjs.Ease.get(1)).to({x:283},10,cjs.Ease.get(1)).to({x:343},10,cjs.Ease.get(1)).to({x:283},10,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({y:124.3},0).wait(1).to({y:121.9},0).wait(1).to({y:120.6},0).wait(1).to({y:119.8},0).wait(1).to({y:119.3},0).wait(1).to({y:118.9},0).wait(1).to({y:118.7},0).wait(1).to({y:118.6},0).to({_off:true},1).wait(10).to({_off:false,y:128.5},0).to({alpha:0.488},10).to({alpha:1},10).wait(1));
