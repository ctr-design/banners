...
p.nominalBounds = new cjs.Rectangle(0,0,507,136);


(lib.doggy = function() {
	this.initialize(img.doggy);
}).prototype = p = new cjs.Bitmap();
...
(lib.Символ27 = function() {
	...
	this.shape.graphics.f("#993300").s().p("AvQE1Qi0AAAAi0IAAkBQAAi0C0AAIehAAQC0AAAAC0IAAEBQAAC0i0AAg");

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-115.7,-30.9,231.6,61.9);
...
(lib.Символ20 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(255,255,255,0)","rgba(255,255,255,0.922)","rgba(255,255,255,0)"],[0,0.498,1],-61.5,0,61.6,0).s().p("Am5QqQitAAAAitIAA76QAAisCtAAIN0AAQCsAAAACsIAAb6QAACtisAAg");

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-61.6,-106.6,123.2,213.4);
...
(lib.Символ9 = function() {
	...
	// Слой 1
	this.instance = new lib.doggy();
	this.instance.setTransform(-46.5,-42.3);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-46.5,-42.3,100,79);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0.1,0,0.518,1.832,89.9,0,0,-0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:160.5},39).wait(49));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-195.5,-32.1,391,64.2);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(104.9,50.5,0.707,0.707,129.8);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({rotation:0,x:314.9,y:86.5,alpha:1},14).to({rotation:-78.2,x:31.4,y:324.5},10).wait(1));
	...
	this.instance_2.setTransform(596.8,77.5,0.707,0.707,-41);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(27).to({_off:false},0).to({rotation:-168.3,x:398.5,y:-0.4,alpha:1},14).to({rotation:-54.8,x:724.4,y:-175.8},10).to({_off:true},1).wait(12));
	...
	this.instance_4.setTransform(192.2,-162.5,0.707,0.707,166.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(21).to({_off:false},0).to({rotation:42.5,x:322.8,y:5.9,alpha:1},14).to({rotation:146.5,x:-47,y:-10},10).to({_off:true},1).wait(18));
	...
	this.instance_6.setTransform(645,14.5,0.732,0.707,0,-106.3,73.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(16).to({_off:false},0).to({skewX:0,skewY:180,x:427.7,y:50.5,alpha:1},14).to({skewX:-132.5,skewY:47.5,x:721,y:288.5},10).to({_off:true},1).wait(23));
	...
	this.instance_8.setTransform(159.9,151.2,0.707,0.707,88.3);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({rotation:-30.7,x:358.8,y:74.8,alpha:1},14).to({rotation:-148.5,x:236.6,y:424.2},10).to({_off:true},1).wait(30));
	...
	this.instance_10.setTransform(88,10,0.707,0.707,-108.5);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:0,x:298,y:46,alpha:1},14).to({rotation:125.5,x:14.5,y:284},10).to({_off:true},1).wait(39));
...
p.nominalBounds = new cjs.Rectangle(47.7,-34.1,75.4,84.8);
...
p.nominalBounds = new cjs.Rectangle(214.6,-33.1,75.4,84.8);
...
(lib.Символ18 = function() {
	...
	mask._off = true;
	mask.graphics.p("Ax4FrQjUAAAAjUIAAkuQAAjSDUgBMAjxAAAQDUABAADSIAAEuQAADUjUAAg");
	mask.setTransform(10.4,5.3);

	// Слой 4
	this.instance = new lib.Символ21();
	this.instance.setTransform(6,-68.3);
	...
	this.instance_1.setTransform(8.2,4.2,0.896,0.896);

	// Режим изоляции
	this.instance_2 = new lib.bt();
	this.instance_2.setTransform(-125.3,-31,0.535,0.535);

	this.addChild(this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-125.3,-31,271.4,72.8);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(3.5,8.4);
	this.instance.compositeOperation = "lighter";
	this.instance._off = true;
...
p.nominalBounds = new cjs.Rectangle(-168.3,-82.4,335.8,122.1);
...
(lib.kalor_640305 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(506.9,244.4,1.214,1.214,0,0,0,23.2,2.6);
	...
	this.instance_4.setTransform(286.2,130);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(166.2,62,880,441);
