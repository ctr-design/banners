...
(lib.Символ36 = function() {
	...
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(104.6,14.8);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,209.2,29.7);
...
(lib.Символ24 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(102.9,8.7);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-1.7,-6.1,209.2,29.7);
...
(lib.Символ15 = function() {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgtB0IAAhFIhGAAIAAhdIBGAAIAAhFIBcAAIAABFIBFAAIAABdIhFAAIAABFg");
	this.shape.setTransform(15.3,8.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(3.7,-3.4,23.3,23.3);
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(104.5,14.8,1,1,0,0,0,104.5,14.8);
...
(lib.Символ39 = function() {
	...
	// Слой 3 - копия: 2 - копия: 2 - копия
	this.instance = new lib.Символ42();
	this.instance.setTransform(104.6,9.6,1,1,0,0,0,104.5,14.8);

	// Слой 3 - копия: 2 - копия: 2
	this.instance_1 = new lib.Символ24();
	this.instance_1.setTransform(129.6,9.1,1,1,0,0,0,127.8,8.2);

	// Слой 3 - копия: 2 - копия
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(104.7,11.1);

	this.addChild(this.shape,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0.1,-5.2,209.2,31.2);
...
p.nominalBounds = new cjs.Rectangle(2.8,-1.7,209.2,31.2);
...
p.nominalBounds = new cjs.Rectangle(-17.2,-14.8,33,32);
...
p.nominalBounds = new cjs.Rectangle(-112.3,-20.4,220.3,32);
...
(lib.Символ41 = function() {
	...
	// Слой 4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-176.4,0.1,176.4,0.1).s().p("A7iKwIAA1gMA3GAAAIAAVgg");
	this.shape.setTransform(-270.4,47.6);
