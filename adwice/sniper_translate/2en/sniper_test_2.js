...
(lib.Символ23 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("");
	this.shape.setTransform(97.2,49.1);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,194.4,98.1);
...
(lib.Символ26_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(97.2,49.1,1,1,0,0,0,97.2,49.1);
...
(lib.Символ21 = function() {
	...
	this.instance.setTransform(97.2,51.1,1,1,0,0,0,97.2,49.1);

	// Слой 1 - копия
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(97.2,51.1);

	// Слой 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(97.2,53.3);

	this.addChild(this.shape_1,this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,2,194.4,100.3);
...
(lib.Символ21_1 = function() {
	...
	// Слой 2
	this.instance_5 = new lib.Символ23_1();
	...
	// Слой 1
	this.instance_7 = new lib.Символ23_1();
...
(lib.Символ22_1 = function() {
	...
	this.instance.setTransform(-47,20,0.964,0.964,0,0,0,87.5,47.1);
	...
	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-130.5,0,130.5,0).s().p("A0XQoMAAAghPMAowAAAMAAAAhPg");
	this.shape_1.setTransform(-23.6,69.8);
