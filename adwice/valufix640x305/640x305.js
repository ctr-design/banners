...
p.nominalBounds = new cjs.Rectangle(-42.5,-40,100,75);
...
(lib.Символ72 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-4.4},9,cjs.Ease.get(-1)).to({y:-10},10,cjs.Ease.get(1)).to({y:-5},10,cjs.Ease.get(-1)).to({y:0},10,cjs.Ease.get(1)).wait(1));
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.6,scaleY:0.6,alpha:0.445},4,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,alpha:1},5,cjs.Ease.get(1)).to({scaleX:1.64,scaleY:1.64,alpha:0},15).to({_off:true},1).wait(8));
...
(lib._640x305 = function(mode,startPosition,loop) {
	...
	this.btngrn.setTransform(131,261,1,1,0,0,0,-92,5.2);
	...
	this.instance.setTransform(58.1,257.1);
...
p.nominalBounds = new cjs.Rectangle(278.4,150.5,777.1,327.6);
