...
(lib.Символ6 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(46.2,12.4);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,92.4,24.7);
...
(lib.Символ5 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(38.9,12.4);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,77.8,24.7);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(96.1,24.5,1,1,0,0,0,38.8,7.9);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[{t:this.instance_1},{t:this.instance_3},{t:this.instance_2}]},1).to({state:[{t:this.instance_1},{t:this.instance_3},{t:this.instance_2}]},1).to({state:[]},1).wait(1));
...
(lib.Символ7 = function() {
	...
	this.instance.setTransform(99.2,24.3,0.82,0.82,0,0,0,38.9,12.3);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(136.6,28.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:128,y:16.6},19).to({x:137.5,y:27},20).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,1.9,151.1,259.1);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(96.4,24.7,1,1,0,0,0,38.8,7.9);
