...
(lib.index = function(mode,startPosition,loop) {
	...
	this.tekst.setTransform(514.4,45.2,0.823,0.823,0,0,0,110.3,16);

	this.bullet = new lib.Символ40();
	this.bullet.setTransform(41.7,215.6,1,1,0,0,0,57.8,15.4);

	this.hp = new lib.Символ17();
	this.hp.setTransform(127,255.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.hp},{t:this.bullet},{t:this.tekst}]}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-207,75.3,1450.1,345.2);
