...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/a.png", id:"_1"},
		{src:"images/b.png", id:"_2"},
		{src:"images/c.png", id:"_3"},
		{src:"images/d.png", id:"_4"},
		{src:"images/f.png", id:"_5"},
		{src:"images/e.png", id:"_6"},
		{src:"images/g.png", id:"_7"},
		{src:"images/Bristlecone_Pines_USA_Ca.jpg", id:"Bristlecone_Pines_USA_Ca"},
		{src:"images/hand.png", id:"hand"},
		{src:"images/tree.png", id:"tree"},
		{src:"images/ty4a.png", id:"ty4a"}
	]
};
...
(lib.Bristlecone_Pines_USA_Ca = function() {
	this.initialize(img.Bristlecone_Pines_USA_Ca);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,266,600);


(lib.ty4a = function() {
	this.initialize(img.ty4a);
}).prototype = p = new cjs.Bitmap();
...
(lib.Символ45 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFCC00","#FFDD45","#FFFFCC","#FFCB46","#FF9656"],[0,0.176,0.518,0.765,1],0,-44.7,0,44.8).s().p("AwwG/IAAt9MAhgAAAIAAN9g");
	this.shape.setTransform(107.3,44.8);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,214.6,89.5);
...
(lib.Символ44 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(96.9,15.7);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,193.8,31.4);
...
(lib.Символ42 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(84.9,16.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,169.8,32.5);
...
(lib.Символ38 = function() {
	...
	// Слой 1
	this.instance = new lib.ty4a();
	this.instance.setTransform(0,23.7,0.851,0.851,-7.4);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,197.9,150.2);
...
(lib.Символ33 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(114.4,37.9);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,228.7,75.8);
...
(lib.Символ11 = function() {
	...
	// Слой 1
	this.instance = new lib.Bristlecone_Pines_USA_Ca();
	this.instance.setTransform(313,257);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(313,257,800,600);
...
(lib.Символ41 = function() {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(84.9,16.3);

	// Символ 43
	this.instance = new lib.Символ43();
	this.instance.setTransform(85.3,16.3,0.815,0.363,0,0,0,107.3,44.8);

	this.instance.mask = mask;

	// Слой 1
	this.instance_1 = new lib.Символ42();
	this.instance_1.setTransform(84.9,19.4,1,1,0,0,0,84.9,16.2);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,169.8,35.7);
...
(lib.Символ40 = function() {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(96.9,15.7);

	// Символ 45
	this.instance = new lib.Символ45();
	this.instance.setTransform(96.9,15.7,0.903,0.35,0,0,0,107.3,44.8);

	this.instance.mask = mask;

	// Слой 1
	this.instance_1 = new lib.Символ44();
	this.instance_1.setTransform(96.9,18.9,1,1,0,0,0,96.9,15.7);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,193.8,34.6);
...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(548.5,-273.5,1,1,0,0,0,111.3,113.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-241.5},4,cjs.Ease.get(-1)).wait(16).to({y:-273.5},10,cjs.Ease.get(1)).wait(1));

	// Символ 40
	this.instance_1 = new lib.Символ40();
	this.instance_1.setTransform(919.4,-241.4,1,1,0,0,0,107.3,112.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({y:-271.4},10,cjs.Ease.get(1)).wait(1).to({y:-241.4},5,cjs.Ease.get(-1)).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(435,-386.7,570.9,67.1);
...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(99,75.1,1,1,0,0,0,99,75.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:98.9,regY:75,scaleX:0.96,scaleY:0.96},14,cjs.Ease.get(-1)).to({regX:99,regY:75.1,scaleX:0.93,scaleY:0.93},15,cjs.Ease.get(1)).to({scaleX:0.97,scaleY:0.97},16,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1},14,cjs.Ease.get(1)).wait(1));
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#66FF00").s().p("AhIB+QgEgFAEgNQAEgOAngzQATgZAHgLQgRBuggAaIgUgRgAAAAAIAAAAIAAAAQB+BggBANQgEAKgPAAQgZAAhRh3gAh8hXQAAg7B7CRQhQgngrgvgAAAgBQAGgJAihFQAqhVASAeQgmBgg+AkIAAAAIAAAAIAAABg");
...
p.nominalBounds = new cjs.Rectangle(38.4,41.7,132.7,130);
...
(lib.Символ37 = function() {
	...
	this.instance.setTransform(266.4,42.6,0.14,0.14,0,0,0,99.1,75.2);

	this.instance_1 = new lib.Символ36();
	this.instance_1.setTransform(229.9,52.2,0.267,0.267,0,0,0,99,75);

	this.instance_2 = new lib.Символ33();
	this.instance_2.setTransform(101.8,75.1,0.502,0.502,0,0,0,114.4,37.9);

	this.instance_3 = new lib.Символ36();
	this.instance_3.setTransform(99,75.1,1,1,0,0,0,99,75.1);

	this.addChild(this.instance_3,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,280.2,150.2);
...
p.nominalBounds = new cjs.Rectangle(-1,0,106.6,321.1);
...
(lib.amazonka640305 = function(mode,startPosition,loop) {
	...
	this.girl.setTransform(316,159.1,1,1,0,0,0,56,159.8);

	this.timeline.addTween(cjs.Tween.get(this.girl).wait(1));

	// Слой 23
	this.button = new lib.Символ48();
	this.button.setTransform(291.2,160,1,1,0,0,0,372.8,185.6);
	...
	this.instance.setTransform(166.7,76.8,0.766,0.766,0,0,0,136.9,75.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 21
	this.instance_1 = new lib.Символ39();
	this.instance_1.setTransform(-121.4,643.2,1,1,0,0,0,276.1,16.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Слой 3
	this.instance_2 = new lib.tree();
	this.instance_2.setTransform(236.2,-98,0.792,0.792);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Слой 22
	this.instance_3 = new lib.Символ46();
	this.instance_3.setTransform(111.3,234,0.743,0.706,0,-7,173,57.5,21.9);

	this.instance_4 = new lib.Символ46();
	this.instance_4.setTransform(1017.4,312.3,1,1,0,0,0,57.4,21.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3}]}).wait(1));

	// Слой 4
	this.fon = new lib.Символ11();
	this.fon.setTransform(61,5.1,1,1,0,0,0,400,300);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-97.9,54.5,1712.5,660.1);
