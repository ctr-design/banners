...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(157.9,142,0.473,0.473,0,0,0,-0.2,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.1,scaleX:0.39,scaleY:0.39,y:130,alpha:0},4).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({scaleX:0.84,scaleY:0.84,y:165.7,alpha:1},4).wait(1));
	...
	this.instance_4.setTransform(369.5,157.4,1,1,0,0,0,369.5,185);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:359.9,regY:167.7,scaleX:1.16,scaleY:1.16,x:389.8,y:134.9},0).wait(1).to({scaleX:1.2,scaleY:1.2,x:397.8,y:133.6},0).wait(1).to({scaleX:1.22,scaleY:1.22,x:402.6,y:132.7},0).wait(1).to({scaleX:1.24,scaleY:1.24,x:405.6,y:132.2},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:407.7,y:131.8},0).wait(1).to({scaleX:1.26,scaleY:1.26,x:409.2,y:131.6},0).wait(1).to({regX:369.5,regY:185,scaleX:1.26,scaleY:1.26,x:422.5,y:153.2},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-19.7,-50,759.2,380.1);
...
(lib.sexy_leg_600x100 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.qwe.setTransform(304,67.2,0.825,0.825,0,0,0,369.4,185.1);

	this.timeline.addTween(cjs.Tween.get(this.qwe).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(283.1,-76.7,931,313.4);
