...
(lib.Символ55 = function() {
	...
	this.instance.setTransform(341.9,-89.2,1,1,0,0,0,215.7,10);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(341.9,-89.2);

	// Слой 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(343.4,-87.7);

	this.addChild(this.shape_1,this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(126.2,-99.2,433,21.5);
...
(lib.Символ20 = function() {
	...
	this.instance.setTransform(362.7,-118,1,1,0,0,0,203.8,13.2);
	...
	this.shape.setTransform(362.7,-118);
	...
	this.shape_1.setTransform(364.7,-116);

	this.addChild(this.shape_1,this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(158.9,-131.2,409.8,28.4);
...
(lib.Символ2 = function() {
	...
	this.instance.setTransform(420.7,224.4,0.821,0.821,0,0,0,73.8,61);

	// Слой 2
	this.instance_1 = new lib.Символ3();
	this.instance_1.setTransform(131.3,79.3,0.562,0.562,0,0,0,7.2,16.8);

	// Слой 1
	this.instance_2 = new lib.Символ1();
	this.instance_2.setTransform(360,167.7,1.027,1.027,0,0,0,369.6,185);

	this.addChild(this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-19.7,-22.3,759.2,380.1);
...
(lib.Символ29копия = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(37,86,0.247,0.247);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({scaleX:0.06,scaleY:0.06,alpha:1},0).to({scaleX:0.33,scaleY:0.33},5).to({scaleX:0.25,scaleY:0.25},2).wait(61).to({y:142.5,alpha:0},7).wait(13).to({scaleX:0.06,scaleY:0.06,y:86,alpha:1},0).to({scaleX:0.33,scaleY:0.33},5).to({scaleX:0.25,scaleY:0.25},2).wait(71).to({y:142.5,alpha:0},7).wait(7));
...
p.nominalBounds = new cjs.Rectangle(-169.5,-53.2,281.3,152.3);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(162.9,113.1,0.646,0.646,0,0,0,-0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.53,scaleY:0.53,y:96.8,alpha:0},4).wait(4));

	// Слой 6
	this.instance_1 = new lib.Символ65();
	this.instance_1.setTransform(343.7,153.7,1,1,0,0,0,176.2,107.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({scaleX:0.77,scaleY:0.77,x:353.6,y:153.4,alpha:1},4).wait(1));

	// Слой 5
	this.instance_2 = new lib.Символ55();
	this.instance_2.setTransform(438,379.1,1,1,0,0,0,275.8,17.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).to({y:314.8},5).wait(1));
	...
	this.instance_4.setTransform(428.6,132.3,1.267,1.269,0,3.6,0,369.5,185.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:359.9,regY:167.7,scaleX:1.42,scaleY:1.42,skewX:1.5,x:439.3,y:98.2},0).wait(1).to({scaleX:1.46,scaleY:1.46,skewX:0.9,x:445,y:95},0).wait(1).to({scaleX:1.49,scaleY:1.49,skewX:0.6,x:448.4,y:93.1},0).wait(1).to({scaleX:1.5,scaleY:1.5,skewX:0.3,x:450.5,y:91.9},0).wait(1).to({scaleX:1.51,scaleY:1.51,skewX:0.2,x:452,y:91},0).wait(1).to({scaleX:1.52,scaleY:1.52,skewX:0.1,x:453,y:90.4},0).wait(1).to({regX:369.5,regY:185,scaleX:1.53,scaleY:1.53,skewX:0,x:468.6,y:116.4},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-78,-130.5,991.8,481.6);
...
(lib.sexy_leg_600x150 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.qwe.setTransform(304,115.2,0.825,0.825,0,0,0,369.4,185.1);

	this.timeline.addTween(cjs.Tween.get(this.qwe).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(235,-70.1,979.1,397);
