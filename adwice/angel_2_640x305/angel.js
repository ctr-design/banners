...
(lib.Символ5 = function() {
	...
	// Слой 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#999999").s().p("AkPBUQA+g2BGgpQAugeAzgYQAqgSAugPQArgMAtgCQA5gGA5AAIA6AHQACALAAALQj6hRlcEeIgRADQARgTATgQg");
	this.shape.setTransform(92.6,107);

	// Слой 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#D7D7D5","#999999"],[0,1],35,10.6,33.5,14.3).s().p("AiUgZQBxAHAtgUQApAZAvAPIAzAVIgHAFQgxALgsAAQhsAAhZhAg");
	this.shape_1.setTransform(47.2,116);

	// Слой 2
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFFEF6","#CCCCCC"],[0,1],-4.7,-9,4.7,9).s().p("AmmDNQAwgSAvgVQFIiOETkJQCECWANBdQACAMAAALQj6hPlcEeIgRADIgDAAQgzAHgqAAQhfAAgnglg");
	this.shape_2.setTransform(81.1,95.4);
