...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/a_1.png", id:"_1"},
		{src:"images/a_2.png", id:"_2"},
		{src:"images/a_3.png", id:"_3"},
		{src:"images/a_4.png", id:"_4"},
		{src:"images/a_5.png", id:"_5"},
		{src:"images/a_6.png", id:"_6"},
		{src:"images/a_7.png", id:"_7"},
		{src:"images/_70918739.png", id:"_70918739"},
		{src:"images/GonzoWallpaper1920x1200.jpg", id:"GonzoWallpaper1920x1200"},
...
(lib._70918739 = function() {
	this.initialize(img._70918739);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,166);


(lib.GonzoWallpaper1920x1200 = function() {
	this.initialize(img.GonzoWallpaper1920x1200);
}).prototype = p = new cjs.Bitmap();
...
(lib.Символ67 = function() {
	...
	// Слой 1
	this.instance = new lib._70918739();
...
(lib.Символ58 = function() {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(118.9,16);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CC0000").s().p("ApgB5Ig7gGIkggCIhBgGIjRgBIgIAAQgngNgKgOQgHgIAAgWQAAgRAKgQQAPgUAhgBQgCgJAAgUQAAgaAIgNQAPgbAvgEIDSgCIAqgGIRrgCIAvgEIAAgCIGxAAQEsAUDgANQASABAOADQAZAGAIAIQAJAJAAAhQAAAnggAOQhTAmgbASIpEACIgpAGImGACQgdAFhdAMIhkAMg");
	this.shape.setTransform(114.5,9.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("AQpC5I0/AAIk/gWIqBgCQgwgMgmhhQAAgUAIgMIDRABIBBAGIEgACIA7AGIIPAAIBmgNQBbgLAdgFIGGgCIApgEIJEgCQAbgTBTglQAggPAAgoQAAghgJgJQgIgJgZgFQBFgUAlAGQA2AHAAA/QAAAwgaAgQghAlhiA1IAKATQAFAMAAANQAAAhgaAZQgbAbguAAIgTgBg");
	this.shape_1.setTransform(123.2,17.7);
...
(lib.Символ57 = function() {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(47.5,15.6);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CC0099").s().p("AnzCPQg6gCgRgZQgHgIAAgLIABgKQgBgFALgTQALgSAAgIIgOgkQgPgigBgDQAAg6AlgXQBEgpDPAYIJQAEQC/AKAyARQAXAIAHAMQADAIAAATQAAAdgWARQgPAKgYAFQhpAUhWAXQgTAGjXATIkDAXQjgAcgkAOIgMAFIg7AAIgMAAg");
	this.shape.setTransform(46.4,10);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#660066").s().p("Ak2B6QgSgCgbgPIgagOQgZAAgtAXQguAWgNAAQgkAAgNgbIgGgdQAAgiAxgcIANAAIA6AAIANgFQAjgNDhgbIECgXQDXgTAUgGQBWgXBogUQAYgGAPgLQgBARgEAJQgGALgVAWQAjALAJAfQADALAAApIABAdQgBAWgKAPQggAth7gBIjKACQgEACg1ACIhEACQlngKgYgEg");
	this.shape_1.setTransform(48.1,22.5);
...
(lib.Символ56 = function() {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(142.1,18.8);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CC0099").s().p("A2dCuIg1AAIgRgGQEUAFgIABgA4BCWQAUAFCJADIiSAAQgHgEgEgEgA4KB2QAAgTAYgcQAYgcAAgaQAAgMC4inQAZAAAXAPQAVAOAEAAQAUAAAtgGIFMgBIBlgGIKJgCIAjgGIDygCIAvgGIKCgCIAjgGII1gCQAogHAjAfQ51Cnp2BPQsKAhgaAQQgGgIAAgVg");
	this.shape.setTransform(134.3,12.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#660066").s().p("AA8D4QingGiqgQIkLgCIhGgGIkjgCQkMgEhEgZQgcgJgFgQQAAgDAAgbQgBgIALgXQAJgSACgIIDGAAQAIgBkTgFInsgJIHYgBICSAAQiJgDgUgGIgCgCIAAgBQAZgPMKggQJ1hPZ2ioQAKAJAJALIAJAMQAaAEAOAPQARASgBAiQABBTgxBVQg8BuhnAOQk4AqkGASQhiAHqKAhgAZ4AAIACAFQAHgFAFgHIgOAHg");
	this.shape_1.setTransform(115.8,22.4);
...
(lib.Символ51 = function() {
	...
	// Слой 1
	this.instance = new lib.GonzoWallpaper1920x1200();
	this.instance.setTransform(231,101,1.019,0.834);
...
p.nominalBounds = new cjs.Rectangle(-9.5,-1.9,172,25);
...
p.nominalBounds = new cjs.Rectangle(-41.8,-2.8,245,64.3);
...
p.nominalBounds = new cjs.Rectangle(-15,-2.2,190.3,26.7);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape_1}]},1).to({state:[]},1).to({state:[{t:this.instance}]},1).wait(1));
...
(lib.amazonka640305 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(503.3,97.6,1,1,0,0,0,99,27.7);
	...
	this.fon.setTransform(34.6,44.6,1,1,0,0,0,333.6,208.5);
	this.fon.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(45, 0, 0, 0))];
	this.fon.cache(229,99,819,421);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(243.1,78.6,827.9,448.5);
