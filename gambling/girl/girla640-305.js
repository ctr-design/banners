...
(lib.Символ30 = function() {
	...
	this.shape.setTransform(71.7,66.7);
	...
	this.shape_1.setTransform(69.8,88.6);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-28.8,58,198.5,43.8);
...
(lib.Символ29 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFCC").s().p("");
	this.shape.setTransform(58.5,-8.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(58.5,-34);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-21.6,-47.6,160.3,51.6);
...
(lib.Символ40 = function() {
	...
	this.instance.setTransform(64.6,13.8,0.865,0.865,0,0,0,55.5,5.7);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(460.5,-194.5,1,1,0,0,0,82,18.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:26.3},9,cjs.Ease.get(1)).wait(27).to({y:265.5},10).to({_off:true},1).wait(4));

	// Символ 29
	this.instance_1 = new lib.Символ29();
	this.instance_1.setTransform(68.9,-198.6,1,1,0,0,0,68.9,22.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).to({y:22.2},9,cjs.Ease.get(1)).wait(27).to({y:261.4},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(349.7,-154.6,198.5,43.8);
...
(lib.Символ30_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(131.6,167.2,0.896,0.896,45,0,0,43.5,50.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:130.1,y:160.5},4).to({x:131.6,y:167.2},6).wait(1));
...
p.nominalBounds = new cjs.Rectangle(77.2,100,113.5,126.4);
...
p.nominalBounds = new cjs.Rectangle(45,50.4,113.5,126.4);
...
(lib.Символ22 = function() {
	...
	this.instance_1.setTransform(99.4,23,1,1,0,0,0,61.6,14.2);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(4.2,-1.8,156.8,49.1);
...
(lib.Символ21 = function() {
	...
	this.instance_1.setTransform(59,27,0.865,0.865,0,0,0,55.5,5.7);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AqbCjQgrAAAAgrIAAjvQAAgrArAAIU3AAQAsAAAAArIAADvQAAArgsAAg");
	this.shape.setTransform(61.6,27.4,0.865,0.865);

	this.addChild(this.shape,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,2.6,153.4,49.1);
...
(lib.Символ36 = function() {
	...
	this.instance_4.setTransform(271.2,151.7,1,1,0,0,0,271.2,22.2);

	this.addChild(this.instance_4,this.instance_3,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(99.1,-25.1,449.1,358.2);


// stage content:
(lib.girla640305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.girl.setTransform(325.9,166.5,1,1,0,0,0,271.2,166.5);

	this.timeline.addTween(cjs.Tween.get(this.girl).wait(1));

	// Слой 10
	this.fon = new lib.Символ33();
	this.fon.setTransform(302.1,181.4,1,1,0,0,0,383.6,1043.8);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(139.2,-708.3,1006.4,2084.4);
